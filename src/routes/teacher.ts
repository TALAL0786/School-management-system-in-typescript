...
//onschedule
router2.post('/uploadassignmentonschedule',assignmentcontroller.upload,assignmentcontroller.onscheduler,assignmentcontroller.sendemail);

router2.post('/sendassigmentgmails',assignmentcontroller.upload,assignmentcontroller.sendemail);
